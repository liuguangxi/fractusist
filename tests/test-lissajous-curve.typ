...
#box(stroke: red+2pt, lissajous-curve(3, 4, 1/4, x-size: 200, y-size: 100, stroke: blue+2pt))

#box(stroke: red+2pt, lissajous-curve(4, 3, 1/4, x-size: 100, y-size: 200, stroke: blue+4pt))

#box(stroke: red+2pt, lissajous-curve(7, 10, 3/8, x-size: 300, y-size: 200, fill: blue.lighten(50%)))

#box(stroke: red+2pt, lissajous-curve(5, 7, 1/2, x-size: 300, y-size: 200, fill: blue.lighten(50%), fill-rule: "even-odd", stroke: none))
